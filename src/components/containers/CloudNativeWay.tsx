  ...
  return (
    <Section>
      <Rowflex style={{ flexFlow: lg ? "row wrap" : "row" }}>
        ...
        {sm || md ? (
          <object
            data="/svg/SmallFeaturesMobile.svg"
            type="image/svg+xml"
            style={{
              width: xs ? "100%" : sm ? "80%" : md ? "60%" : "",
              transform: xs ? "scale(1.13) translate(0, 3rem)" : "",
              marginBottom: xs ? "5rem" : "1rem",
            }}
          ></object>
        ) : (
          <object
            data="/svg/SmallFeaturesDesktop.svg"
            type="image/svg+xml"
            style={{ width: "100%", minWidth: "40rem", maxWidth: "34rem" }}
          ></object>
        )}
      </Rowflex>
    </Section>
