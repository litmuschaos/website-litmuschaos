const AdopterList = [
  ...
  },
  {
    ...
    para:
      "Orange S.A., formerly France Télécom S.A., stylized as france telecom, is a French multinational and fourth largest telecommunications corporation in Europe.",
    link: "orange",
  },
  {
    bgColor: "#E1F0F2",
  ...
  {
    bgColor: "linear-gradient(290.13deg, #980732 0%, #E1094A 98.51%)",
    reverse: true,
    head:
