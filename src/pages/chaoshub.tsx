...
const ChaoshubImage: React.FC = () => {
  ...
  {
    return(
      <img  style={{width : "20rem", height : "22.5rem", marginTop :"-2rem" }}src="/svg/ChaoshubHeroImage.svg" alt="Mayadata Logo" />
      )
  }
  else if(lg)
  {
    return(
      <img  style={{width : "30rem", height : "22.5rem", marginTop :"-2rem" }}src="/svg/ChaoshubHeroImage.svg" alt="Mayadata Logo" />
      )
  }
  else{
      return(
    <img  style={{width : "40rem", height : "30rem", marginTop :"-2rem" }}src="/svg/ChaoshubHeroImage.svg" alt="Mayadata Logo" />
    )
  }
...
const AboutRessilence: React.FC = () => {
  ...
  return(
    <div style={{maxWidth :"40.6875rem", margin:lg?"3rem 1rem 2rem 1rem": '5rem 0 5rem 0'}}>
      ...
      <ResponsiveRow>
        <h1 style={{fontSize : lg ?"3rem":"3.5rem",color : "#109B67", width : lg? "12rem": "15rem"}}>&#60; 90%</h1>
        <p style={{maxWidth: lg? "auto":"25rem", margin:"auto", fontSize: '1rem', color : "#6F6F6F"}}>of the resilience of your service depends on fixing or tuning the weaknesses in the configuration or code of the rest of micro services including Kubernetes.</p>
      </ResponsiveRow>
      <hr style={{ width: "100%", margin: "1rem auto"}} />
